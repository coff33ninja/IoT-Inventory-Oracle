...
import BudgetManagementDashboard from "./components/BudgetManagementDashboard";
      ...
      <main
        ...
        <div
          ...
          {currentView === "projects" && (
            <ProjectsView onAiKickstart={handleAiKickstart} />
          )}
          {currentView === "chat" && (
            <ChatView initialMessage={chatInitialMessage} />
          )}
          {currentView === "analytics" && <AnalyticsDashboard />}
          {currentView === "budget" && <BudgetManagementDashboard />}
          {currentView === "technical-docs" && <TechnicalDocumentationHub />}
