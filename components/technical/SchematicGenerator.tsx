              ...
              <div className="p-6">
                ...
                {selectedSymbols.length === 0 ? (
                  <div className="text-center py-12 border-2 border-dashed border-gray-300 rounded-lg">
                    <CircuitBoardIcon className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                    <p className="text-gray-600">No components in circuit</p>
                    <button
                      onClick={() => addComponentToCircuit(selectedComponent)}
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
        <div className="flex items-start">
          ...
          <div className="text-sm text-purple-700">
            <p className="font-medium mb-1">Schematic Generator Features:</p>
