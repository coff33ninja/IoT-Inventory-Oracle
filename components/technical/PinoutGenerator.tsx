...
const PinoutGenerator: React.FC<PinoutGeneratorProps> = ({
  ...
  const getPinTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'ground': return 'bg-gray-100 text-gray-800 border-gray-200';
            ...
            {leftPins.map((pin, index) => (
              ...
              >
                <div className="text-right mr-2 min-w-16">
                  <div className="text-xs font-medium text-gray-700">{pin.name}</div>
        ...
        <>
              ...
              <div>
                ...
                <div className="flex items-center space-x-4 mt-2 text-sm text-gray-600">
                  {specification?.packageInfo && (
                    <>
                      <span className="px-2 py-1 bg-gray-100 rounded">{specification.packageInfo.type}</span>
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className={`px-3 py-1 rounded text-sm ${
                    viewMode === 'diagram' ? 'bg-blue-100 text-blue-800' : 'text-gray-600 hover:bg-gray-100'
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded text-sm ${
                    viewMode === 'table' ? 'bg-blue-100 text-blue-800' : 'text-gray-600 hover:bg-gray-100'
                  }`}
                >
                  Table
                </button>
          ...
          {!specification?.pinout ? (
            <div className="bg-white p-8 rounded-lg shadow border text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Pinout Available</h3>
              ...
              {viewMode === 'diagram' ? (
                <div>
                  ...
                  <div className="p-4 border-t border-gray-200">
                    <h5 className="font-medium text-gray-900 mb-3">Pin Types</h5>
                      ...
                      {specification.pinout.map((pin, index) => (
                        <tr
                          ...
                          className={`hover:bg-gray-50 cursor-pointer ${
                            selectedPin?.pin === pin.pin ? 'bg-blue-50' : ''
                          }`}
                          onClick={() => setSelectedPin(pin)}
                        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Pin Number:</span>
                    ...
                    {selectedPin.voltage && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{selectedPin.voltage}V</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  {selectedPin.alternateFunction && (
                    <div className="mt-3">
                      <h6 className="font-medium text-gray-900 text-sm">Alternate Function</h6>
                      <p className="text-sm text-gray-600">{selectedPin.alternateFunction}</p>
                    </div>
                  )}
                </div>
              </div>
