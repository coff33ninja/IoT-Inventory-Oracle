...
export const TrendingDownIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const ExclamationTriangleIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const FunnelIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const ArrowUpIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5" />
  </svg>
);

export const ArrowDownIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const AdjustmentsHorizontalIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const HandThumbUpIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const HandThumbDownIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 15h2.25m8.024-9.75c.011.05.028.1.052.148.591 1.2.924 2.55.924 3.977a8.96 8.96 0 01-.999 4.125m.023-8.25c-.076-.365.183-.75.575-.75h.908c.889 0 1.713.518 1.972 1.368.339 1.11.521 2.287.521 3.507 0 1.553-.295 3.036-.831 4.398C20.613 14.547 19.833 15 18.75 15H15.31c-.483 0-.964.078-1.423.23l-3.114 1.04a4.501 4.501 0 01-1.423.23h-1.27a.75.75 0 01-.75-.75v-.109c0-.718.273-1.408.732-1.943.178-.207.411-.372.683-.463.35-.117.67-.323.90-.609C10.861 12.754 11.25 11.9 11.25 11V4.5A2.25 2.25 0 009 2.25a.75.75 0 00-.75.75v.633c0 .573-.11 1.14-.322 1.672-.304.759-.93 1.331-1.653 1.715a9.04 9.04 0 00-2.86 2.4c-.498.634-1.226 1.08-2.032 1.08h-.515c-.414 0-.75.336-.75.75V14.25c0 .414.336.75.75.75h.515c.806 0 1.534.446 2.031 1.08.72.906 1.57 1.7 2.861 2.4.723.384 1.35.956 1.653 1.715.212.532.322 1.099.322 1.672V21a.75.75 0 00.75.75A2.25 2.25 0 0012 19.5v-1.633c0-.573.11-1.14.322-1.672.304-.759.93-1.331 1.653-1.715a9.04 9.04 0 002.86-2.4c.498-.634 1.226-1.08 2.032-1.08h.515c.414 0 .75-.336.75-.75v-7.5c0-.414-.336-.75-.75-.75h-.515z" />
  </svg>
);

export const ChatBubbleLeftIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const CircuitBoardIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.125C8.25 5.004 8.754 5.25 9 5.25h1.5c.621 0 1.125-.504 1.125-1.125V3m0 0h1.875c1.036 0 1.875.84 1.875 1.875v1.5c0 1.036-.84 1.875-1.875 1.875h-7.5C5.839 8.25 5 7.41 5 6.375v-1.5C5 3.839 5.84 3 6.875 3H8.25zM5 10.25h2.25c.621 0 1.125.504 1.125 1.125v1.25c0 .621-.504 1.125-1.125 1.125H5V10.25zM19 10.25h-2.25c-.621 0-1.125.504-1.125 1.125v1.25c0 .621.504 1.125 1.125 1.125H19V10.25zM8.25 15h7.5v4.875c0 1.035-.84 1.875-1.875 1.875h-3.75c-1.036 0-1.875-.84-1.875-1.875V15z" />
  </svg>
);
...
export const ThermometerIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882-.265-4.185-.75M12 20.25c1.472 0 2.882-.265 4.185-.75M18.75 4.97A48.254 48.254 0 0 0 12 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 0 1-2.031.352 5.988 5.988 0 0 1-2.031-.352c-.483-.174-.711-.703-.59-1.202L18.75 4.971Zm-16.5.52c.99-.203 1.99-.377 3-.52m0 0l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.989 5.989 0 0 1-2.031.352 5.989 5.989 0 0 1-2.031-.352c-.483-.174-.711-.703-.59-1.202L5.25 4.971Z" />
  </svg>
);

export const DocumentTextIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5-3H12M8.25 21h8.25a2.25 2.25 0 002.25-2.25V5.25a2.25 2.25 0 00-2.25-2.25H8.25a2.25 2.25 0 00-2.25 2.25v13.5a2.25 2.25 0 002.25 2.25z" />
  </svg>
);

export const CpuChipIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.125C8.25 5.004 8.754 5.25 9 5.25h1.5c.621 0 1.125-.504 1.125-1.125V3m0 0h1.875c1.036 0 1.875.84 1.875 1.875v1.5c0 1.036-.84 1.875-1.875 1.875h-7.5C5.839 8.25 5 7.41 5 6.375v-1.5C5 3.839 5.84 3 6.875 3H8.25zM5 10.25h2.25c.621 0 1.125.504 1.125 1.125v1.25c0 .621-.504 1.125-1.125 1.125H5V10.25zM19 10.25h-2.25c-.621 0-1.125.504-1.125 1.125v1.25c0 .621.504 1.125 1.125 1.125H19V10.25zM8.25 15h7.5v4.875c0 1.035-.84 1.875-1.875 1.875h-3.75c-1.036 0-1.875-.84-1.875-1.875V15z" />
  </svg>
);
